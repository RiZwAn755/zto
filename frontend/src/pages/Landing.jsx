...
const Landing = () => {
  ...
  return (
    <div style={{ minHeight: '0vh', display: 'flex', flexDirection: 'column', background: 'linear-gradient(135deg, #2b4eff 0%, #6a5acd 100%)', position: 'relative' }}>
      <Navbar />
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 12px 32px 12px', position: 'relative', zIndex: 1, paddingTop: 80 }}>
        <section style={{
          ...
          maxWidth: 500,
          width: '100%',
          padding: '18px 32px 14px 32px', // further reduced padding
          textAlign: 'center',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          position: 'relative',
          minHeight: 260, // further reduce card height
        }}>
          {/* Tagline badge */}
          <span style={{
          ...
          {studentAnimation && (
            <Lottie
              ...
              loop
              style={{ width: 400, height: 320, margin: "0 auto 12px auto" }}
            />
          )}
